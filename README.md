...
This policy CAT will maintain security group rules based on the current active probes published by Pingdoms public feed [ https://my.pingdom.com/probes/feed ]. This policy can be used to enable monitoring on resources that otherwise are restricted to internal / non-public access.
