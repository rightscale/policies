...
define generate_report($instance_ids,$low_cpu_threshold,$period,$days_back) do
  ...
  foreach $instance in $instance_ids do
    $instance_table = '<tr style="border: 2px solid black; border-collapse: collapse; padding: 5px; text-align: left;"><td style="border: 2px solid black; border-collapse: collapse; padding: 5px; text-align: left;">' + to_s($instance) + '</td></tr>'
  ...
  $body_html = $body_html + '<table style="border: 2px solid black; border-collapse: collapse; padding: 5px; text-align: left;"><tr style="border: 2px solid black; border-collapse: collapse; padding: 5px; text-align: left;"><th style="border: 2px solid black; border-collapse: collapse; padding: 5px; text-align: left;">AWS Instance ID</th>' + $table_rows + '</table>'
